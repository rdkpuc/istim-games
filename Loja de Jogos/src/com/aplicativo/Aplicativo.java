...
import com.leituraescita.dados.*;
import com.classes.*;
public class Aplicativo {
	...
	public void menuAplicativo(int indice) {
		...
		case 1:
			...
			while(opcaoJogos != 6) {
				String menuJogos ="1 - Adicionar Jogo \n" +
		                 ...
		                 "4 - Mostrar Todos os Jogos por Ordem de Inserção \n"+
					     "5 - Mostrar Todos os Jogos por Ordem de Lançamento \n"  +
		                 "6 - Sair \n";
		...
		case 3 : 
			...
			String lojaDeJogos ="1 - Comprar Jogo \n"
							...
							+ "3 - Mostrar Media de Avaliações de um Jogo \n"
	...
	public void menuJogos(int indice) {
		...
		break;
		case 4:
			System.out.println("Jogos em Ordem de Inserção : ");
			System.out.println(lista.mostrarLista());
		break;
		case 5:
			System.out.println("Jogos em Ordem de Lançamento : ");
	...
	public void menuLoja(int indice) {
		...
		case 1:
			...
			System.out.println("Qual a Avaliação do Jogo : ");
		...
		break;
		case 3:
			System.out.println("Qual o nome do Jogo que deseja ver a média de Avaliação ? ");
			nomeJogo = in.nextLine();
			jogoComprado = lista.mostrarJogo(nomeJogo);
			if(jogoComprado != null) {
				System.out.println("A Média de Avaliação de " +  nomeJogo + " é : " + jogoComprado.mostrarMediaDeAvaliacao());
			}
			else {
